...
# Disclaimer
echo "Este script é fornecido como está, sem nenhuma garantia."
echo "Use por sua conta e risco. Erros ou comportamentos inesperados podem ocorrer."
echo "Sugestões de melhorias são sempre bem-vindas!"
